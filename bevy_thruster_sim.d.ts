...
export interface InitOutput {
  ...
  readonly closure1104_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6a2c59ba3b5382c4: (a: number, b: number) => void;
  readonly closure4409_externref_shim: (a: number, b: number, c: any, d: any) => void;
