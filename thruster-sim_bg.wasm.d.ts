...
export const closure1224_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5029db9f92f71676: (a: number, b: number) => void;
export const closure5198_externref_shim: (a: number, b: number, c: any, d: any) => void;
